...
test("Request to create user records targeting peers from " + CONSTANTS.ORG1_NAME + " Org and " + CONSTANTS.ORG2_NAME + " Org ", async t => {
  ...
  t.is(response.body.message, 'Successfully invoked the chaincode for function '+ CONSTANTS.FCN_CREATE_DOCTOR +' to the channel ' + CONSTANTS.CHANNEL_NAME);
});
